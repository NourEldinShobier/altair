 ...
 *
 * `error_page.ts` can already take a stack apart and read source around a
...
import type { StackFrame } from "./error_page.js";
import { parseStack } from "./error_page.js";
import { RESCUE_RESPONSES } from "./rescue_responses.js";
