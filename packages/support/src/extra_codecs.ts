 ...
 *
 * `typed_serializer.ts` owns the registry and the types every application
...
import type { TypeCodec } from "./typed_serializer.js";
 ...
 *
 * The reader is `typed_serializer.ts`'s `readTimeZone`, which already resolves
