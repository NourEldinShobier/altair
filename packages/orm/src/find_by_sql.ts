...
import { type AsyncExecutor, BoundedExecutor } from "./batch_loader.js";
import { FutureResult } from "./future_result.js";
 ...
 *
 * `batch_loader.ts` already owns the bounded executor and the reason for it —
