 ...
 *
 * `switching-isolation.test.ts` covers the first two of these to be found.
...
import { collectingQueriesForExplain, recordForExplain, uncached } from "../src/query-analysis.js";
import { isCaching, withQueryCache } from "../src/query-cache.js";
import {
  preserveLockVersionOnTouch,
  preservingLockVersionOnTouch,
  setPreserveLockVersionOnTouch,
} from "../src/locking-and-timestamps.js";
...
describe("running uncached", () => {
  /**
   * Against the cache that runs — `query-cache.ts`'s, the one
