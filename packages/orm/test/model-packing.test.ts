 ...
 *
 * `record-pack.test.ts` covers the payload's shape against a fake. These are
...
import { dumpRecords, loadRecords } from "../src/record-pack.js";
import {
  UnknownPackedClass,
  modelRecordReader,
  modelRecordWriter,
