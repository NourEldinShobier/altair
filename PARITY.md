...
| `@altair/view`       | 537   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 25.1% of Rails' test count, not 25.1% of Rails.
