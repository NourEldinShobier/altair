...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1946  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 3142  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 1176  | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/testing`    | 285   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 34.6% of Rails' test count, not 34.6% of Rails.
