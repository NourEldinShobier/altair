...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1260  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 1653  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 655   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/cable`      | 125   | Action Cable, protocol-compatible with Rails' client                       |
| `@altair/storage`    | 209   | Disk and S3 services, blobs, attachments, variants, direct uploads         |
| `@altair/view`       | 362   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 19.7% of Rails' test count, not 19.7% of Rails.
