...
| `@altair/orm`        | 1945  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/view`       | 510   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
| `@altair/mailer`     | 246   | Messages, TSX bodies, delivery methods                                     |
...
What remains everywhere is depth: 23.8% of Rails' test count, not 23.8% of Rails.
