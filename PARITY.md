...
| `@altair/cable`      | 324   | Action Cable, protocol-compatible with Rails' client                       |
...
What remains everywhere is depth: 36.4% of Rails' test count, not 36.4% of Rails.
