...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 2379  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
What remains everywhere is depth: 42.4% of Rails' test count, not 42.4% of Rails.
