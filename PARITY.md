...
| `@altair/orm`        | 1132  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 507   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
What remains everywhere is depth: 15.1% of Rails' test count, not 15.1% of Rails.
