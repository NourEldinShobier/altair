...
| `@altair/view`       | 374   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 20.4% of Rails' test count, not 20.4% of Rails.
