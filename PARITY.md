...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 2152  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 3675  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/router`     | 337   | Resourceful routing, typed path helpers                                    |
...
What remains everywhere is depth: 39.0% of Rails' test count, not 39.0% of Rails.
