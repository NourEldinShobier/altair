...
| `@altair/orm`        | 2042  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 812   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
What remains everywhere is depth: 24.3% of Rails' test count, not 24.3% of Rails.
