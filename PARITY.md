...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1443  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
What remains everywhere is depth: 23.1% of Rails' test count, not 23.1% of Rails.
