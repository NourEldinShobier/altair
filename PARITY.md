...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1665  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
What remains everywhere is depth: 26.6% of Rails' test count, not 26.6% of Rails.
