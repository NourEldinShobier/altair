...
| `@altair/cable`      | 350   | Action Cable, protocol-compatible with Rails' client                       |
...
What remains everywhere is depth: 36.5% of Rails' test count, not 36.5% of Rails.
