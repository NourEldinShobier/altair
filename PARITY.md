...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 2209  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 3788  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 1288  | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
| `@altair/cli`        | 191   | Generators, db tasks, file loading, encrypted credentials                  |
| `@altair/router`     | 354   | Resourceful routing, typed path helpers                                    |
...
| `@altair/testing`    | 434   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 39.7% of Rails' test count, not 39.7% of Rails.
