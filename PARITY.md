...
| `@altair/orm`        | 1844  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/storage`    | 251   | Disk and S3 services, blobs, attachments, variants, direct uploads         |
| `@altair/view`       | 488   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 21.8% of Rails' test count, not 21.8% of Rails.
