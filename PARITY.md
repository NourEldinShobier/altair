...
| `@altair/orm`        | 1203  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 537   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
What remains everywhere is depth: 15.6% of Rails' test count, not 15.6% of Rails.
