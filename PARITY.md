...
| `@altair/orm`        | 2089  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 846   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/view`       | 520   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 24.6% of Rails' test count, not 24.6% of Rails.
