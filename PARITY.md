...
| `@altair/view`       | 587   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 29.0% of Rails' test count, not 29.0% of Rails.
