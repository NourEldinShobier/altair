...
| `@altair/view`       | 941   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 44.5% of Rails' test count, not 44.5% of Rails.
