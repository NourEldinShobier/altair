...
| `@altair/testing`    | 386   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 35.4% of Rails' test count, not 35.4% of Rails.
