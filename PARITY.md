...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 2265  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
| `@altair/router`     | 415   | Resourceful routing, typed path helpers                                    |
...
What remains everywhere is depth: 40.7% of Rails' test count, not 40.7% of Rails.
