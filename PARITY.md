...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 942   | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 1053  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 479   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/storage`    | 169   | Disk and S3 services, blobs, attachments, variants, direct uploads         |
| `@altair/view`       | 304   | TSX rendering, layouts, Inertia protocol, form builders                    |
| `@altair/jobs`       | 121   | Jobs, queues, retries, worker                                              |
...
| `@altair/mailer`     | 140   | Messages, TSX bodies, delivery methods                                     |
...
What remains everywhere is depth: 14.2% of Rails' test count, not 14.2% of Rails.
