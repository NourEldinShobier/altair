...
| `@altair/cable`      | 81    | Action Cable, protocol-compatible with Rails' client                       |
...
What remains everywhere is depth: 15.3% of Rails' test count, not 15.3% of Rails.
