...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1829  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 2581  | Connection, migrations, models, relations, associations, ActiveModel       |
...
What remains everywhere is depth: 30.0% of Rails' test count, not 30.0% of Rails.
