...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 2178  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 3706  | Connection, migrations, models, relations, associations, ActiveModel       |
...
What remains everywhere is depth: 39.2% of Rails' test count, not 39.2% of Rails.
