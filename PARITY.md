...
| `@altair/orm`        | 4429  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/view`       | 988   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 44.8% of Rails' test count, not 44.8% of Rails.
