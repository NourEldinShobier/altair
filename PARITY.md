...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1169  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 1620  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 625   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/cable`      | 109   | Action Cable, protocol-compatible with Rails' client                       |
...
| `@altair/testing`    | 175   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 18.9% of Rails' test count, not 18.9% of Rails.
