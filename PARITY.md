...
| `@altair/view`       | 237   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 13.5% of Rails' test count, not 13.5% of Rails.
