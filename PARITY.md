...
| `@altair/controller` | 672   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/view`       | 398   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 20.5% of Rails' test count, not 20.5% of Rails.
