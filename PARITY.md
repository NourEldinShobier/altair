...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 2234  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 3892  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/router`     | 382   | Resourceful routing, typed path helpers                                    |
...
What remains everywhere is depth: 40.4% of Rails' test count, not 40.4% of Rails.
