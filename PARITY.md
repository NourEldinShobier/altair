...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1084  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 1369  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/view`       | 332   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 17.0% of Rails' test count, not 17.0% of Rails.
