...
| `@altair/cable`      | 194   | Action Cable, protocol-compatible with Rails' client                       |
...
What remains everywhere is depth: 23.4% of Rails' test count, not 23.4% of Rails.
