...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 914   | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
| `@altair/view`       | 282   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 13.7% of Rails' test count, not 13.7% of Rails.
