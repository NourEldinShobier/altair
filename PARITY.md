...
| `@altair/controller` | 439   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
| `@altair/cli`        | 142   | Generators, db tasks, file loading, encrypted credentials                  |
