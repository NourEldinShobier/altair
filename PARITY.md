...
| `@altair/cli`        | 159   | Generators, db tasks, file loading, encrypted credentials                  |
...
| `@altair/storage`    | 142   | Disk and S3 services, blobs, attachments, variants, direct uploads         |
