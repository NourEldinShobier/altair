...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1584  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
What remains everywhere is depth: 25.7% of Rails' test count, not 25.7% of Rails.
