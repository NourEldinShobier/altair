...
| `@altair/view`       | 978   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 44.6% of Rails' test count, not 44.6% of Rails.
