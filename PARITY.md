...
| `@altair/testing`    | 347   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 35.2% of Rails' test count, not 35.2% of Rails.
