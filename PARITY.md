...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1471  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 1895  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 783   | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
What remains everywhere is depth: 23.3% of Rails' test count, not 23.3% of Rails.
