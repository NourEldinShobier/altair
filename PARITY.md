...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1981  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 3215  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/testing`    | 317   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 35.1% of Rails' test count, not 35.1% of Rails.
