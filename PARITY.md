...
| `@altair/orm`        | 4487  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 1423  | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/cable`      | 385   | Action Cable, protocol-compatible with Rails' client                       |
| `@altair/storage`    | 320   | Disk and S3 services, blobs, attachments, variants, direct uploads         |
| `@altair/view`       | 1003  | TSX rendering, layouts, Inertia protocol, form builders                    |
| `@altair/jobs`       | 292   | Jobs, queues, retries, worker                                              |
| `@altair/testing`    | 509   | Transactional tests, fixtures, factories, test databases                   |
| `@altair/core`       | 250   | Config, boot lifecycle, request handler, credentials, logging              |
| `@altair/mailer`     | 351   | Messages, TSX bodies, delivery methods                                     |
...
What remains everywhere is depth: 45.3% of Rails' test count, not 45.3% of Rails.
