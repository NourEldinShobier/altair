...
| `@altair/orm`        | 1712  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/view`       | 429   | TSX rendering, layouts, Inertia protocol, form builders                    |
| `@altair/jobs`       | 149   | Jobs, queues, retries, worker                                              |
| `@altair/testing`    | 200   | Transactional tests, fixtures, factories, test databases                   |
...
What remains everywhere is depth: 20.7% of Rails' test count, not 20.7% of Rails.
