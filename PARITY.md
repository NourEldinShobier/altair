...
| `@altair/cable`      | 254   | Action Cable, protocol-compatible with Rails' client                       |
...
What remains everywhere is depth: 29.3% of Rails' test count, not 29.3% of Rails.
