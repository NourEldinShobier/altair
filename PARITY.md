...
| `@altair/cli`        | 171   | Generators, db tasks, file loading, encrypted credentials                  |
...
| `@altair/core`       | 144   | Config, boot lifecycle, request handler, credentials, logging              |
...
What remains everywhere is depth: 12.4% of Rails' test count, not 12.4% of Rails.
