...
| `@altair/cable`      | 90    | Action Cable, protocol-compatible with Rails' client                       |
...
What remains everywhere is depth: 17.7% of Rails' test count, not 17.7% of Rails.
