...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1864  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
| `@altair/orm`        | 2712  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/router`     | 206   | Resourceful routing, typed path helpers                                    |
...
What remains everywhere is depth: 31.2% of Rails' test count, not 31.2% of Rails.
