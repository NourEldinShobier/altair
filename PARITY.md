...
| `@altair/orm`        | 2758  | Connection, migrations, models, relations, associations, ActiveModel       |
...
| `@altair/view`       | 735   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 31.7% of Rails' test count, not 31.7% of Rails.
