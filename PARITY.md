...
| -------------------- | ----- | -------------------------------------------------------------------------- |
| `@altair/support`    | 1519  | Inflector, callbacks, cache, i18n, logging, durations, time zones          |
...
What remains everywhere is depth: 24.8% of Rails' test count, not 24.8% of Rails.
