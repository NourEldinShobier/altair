...
| `@altair/orm`        | 4352  | Connection, migrations, models, relations, associations, ActiveModel       |
| `@altair/controller` | 1378  | Filters, strong params, rendering, dispatch, cookies, sessions, CSRF, i18n |
...
| `@altair/view`       | 913   | TSX rendering, layouts, Inertia protocol, form builders                    |
...
What remains everywhere is depth: 44.0% of Rails' test count, not 44.0% of Rails.
